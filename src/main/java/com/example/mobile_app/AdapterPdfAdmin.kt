...
import com.example.mobile_app.databinding.RowPdfAdminBinding
...
class AdapterPdfAdmin :RecyclerView.Adapter<AdapterPdfAdmin.HolderPdfAdmin>, Filterable {
    ...
    override fun onBindViewHolder(holder: HolderPdfAdmin, position: Int) {
        ...
        //1) Edit Book , 2) Delete Books
        holder.moreBtn.setOnClickListener {
            moreOptionsDialog(model, holder)
        }

        //handle item click, open pdfDetailActivity activity, lets
        ...
        builder.setTitle("Choose Option")
            .setItems(options){ dialog, position->
                ...
                if (position==0){
                    ...
                    intent.putExtra("bookId", bookId) //passes bookId, will be used to edit
                    context.startActivity(intent)
                }
                else if (position == 1){
                    //Delete is clicked
