...
class RegisterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        progressDialog.setTitle("Please White")
    ...
    private fun updateUserInfo() {
        ...
        //get current user uid , since user is registered so we can get it
        ...
        hashMap["userType"] = "user" //possible values are user/admin , will change vale to admin manually in firebase db
