...
import com.example.mobile_app.databinding.ActivityPdfAddBinding
...
class PdfAddActivity : AppCompatActivity() {
    ...
    //setup view binding activity_pdf-add --> ActivityPdfBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.submitBtn.setOnClickListener{
            //STEP1: Validate Data
            //STEP2: Upload to pdf to firebase storage
    ...
    private fun uploadPdfInfoToDb(uploadedPdfUrl: String, timestamp: Long) {
        ...
        //STEP4: Upload Pdf info to firebase db
        Log.d(TAG, "uploadPdfInfoDb: uploading to db")
        ...
        //db reference DB > Books > BooId > (Book Info)
